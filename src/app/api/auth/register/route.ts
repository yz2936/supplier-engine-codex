...
export async function POST(req: Request) {
  try {
    ...
    const message = err instanceof Error ? err.message : "Registration service temporarily unavailable. Please retry.";
    ...
    return NextResponse.json({ error: isKnown ? message : "Registration service temporarily unavailable. Please retry." }, { status: 503 });
  }
}
